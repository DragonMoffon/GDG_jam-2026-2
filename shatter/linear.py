...
class Vec2(Sequence[float]):
    ...
    @overload
    def __init__(self, x: float = 0.0, y: None = None): ...
    @overload
...
class Vec3(Sequence[float]):
    ...
    @overload
    def __init__(self, x: float = 0.0, y: None = None, z: None = None): ...
    @overload
...
class Vec4(Sequence[float]):
    ...
    @overload
    def __init__(self, x: float = 0.0, y: None = None, z: None = None, w: None = None): ...
    @overload
